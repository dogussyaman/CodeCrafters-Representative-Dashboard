...
export default async function Page() {
  const campaigns = await getCampaignsByUnit("birim-b");

  return (
    <div className="container mx-auto p-6">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Müşteri Hizmetleri Kampanyaları</h1>
          <p className="mt-2 text-muted-foreground">
            Güncel araç kiralama fırsatlarını ve indirimlerini keşfedin.
          </p>
        </div>
        <div className="rounded-full bg-orange-100 px-4 py-1.5 text-sm font-medium text-orange-700 dark:bg-orange-900/30 dark:text-orange-400">
